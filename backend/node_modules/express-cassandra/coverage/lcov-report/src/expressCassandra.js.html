...
<head>
    <title>Code coverage report for src/expressCassandra.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> expressCassandra.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">85.64% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>167/195</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">86.28% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>151/175</span>
            </div>
...
<span class="cline-any cline-yes">672x</span>
<span class="cline-any cline-yes">672x</span>
<span class="cline-any cline-yes">20008x</span>
<span class="cline-any cline-yes">20008x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const semver = require('semver');
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (!semver.satisfies(process.version, '&gt;=6.0.0')) {
<span class="cstat-no" title="statement not covered" >  require('babel-polyfill');</span>
}
&nbsp;
...
CassandraClient.syncModelFileToDB = (file, callback) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!file.name.includes('Model')) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (modelName) {
    const fileLocation = path.join(CassandraClient.directory, file.path);
    // eslint-disable-next-line import/no-dynamic-require
    const defaultModelSchema = require(fileLocation);
<span class="branch-1 cbranch-no" title="branch not covered" >    const m</span>odelSchema = defaultModelSchema.default ? defaultModelSchema.default : defaultModelSchema;
...
CassandraClient.bind = (options, cb) =&gt; {
  ...
  CassandraClient.orm.initAsync()
    ...
    .then(() =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (cb) cb();
    })
    .catch(<span class="fstat-no" title="function not covered" >(err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (cb &amp;&amp; _.isArray(err) &amp;&amp; err.length &gt; 0) <span class="cstat-no" title="statement not covered" >cb(e</span>rr[0]);</span>
      else <span class="cstat-no" title="statement not covered" >if (cb) <span class="cstat-no" title="statement not covered" >cb(err);</span></span>
    });
};
&nbsp;
...
&nbsp;
CassandraClient.uuidFromBuffer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(buf) =&gt; (n</span></span>ew cql.types.Uuid(buf));
&nbsp;
...
&nbsp;
CassandraClient.timeuuidFromBuffer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(buf) =&gt; (n</span></span>ew cql.types.TimeUuid(buf));
&nbsp;
  ...
  Promise.all(beforeHooks)
    ...
    .then((response) =&gt; {
      ...
      for (let i = 0; i &lt; queries.length; i++) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (afterHookResponse !== true) {
<span class="cstat-no" title="statement not covered" >          callback(afterHookResponse);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
      }
...
CassandraClient.doBatch = function f(queries, options, callback) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (arguments.length === 2) {
    callback = options;
    options = {};
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return cql;</span>
    },
  },
  instance: {
    get() {
  ...
  close: {
<span class="fstat-no" title="function not covered" >    get() {</span>
<span class="cstat-no" title="statement not covered" >      return C</span>assandraClient.orm.close;
    },
  },
  closeAsync: {
    get() {
...
Object.defineProperties(CassandraClient.prototype, {
  consistencies: {
<span class="fstat-no" title="function not covered" >    get() {</span>
<span class="cstat-no" title="statement not covered" >      return c</span>ql.types.consistencies;
    },
  },
  datatypes: {
<span class="fstat-no" title="function not covered" >    get() {</span>
...
<span class="cstat-no" title="statement not covered" >      return cql;</span>
  ...
  closeAsync: {
<span class="fstat-no" title="function not covered" >    get() {</span>
<span class="cstat-no" title="statement not covered" >      return P</span>romise.promisify(this.orm.close);
    },
  },
});
&nbsp;
