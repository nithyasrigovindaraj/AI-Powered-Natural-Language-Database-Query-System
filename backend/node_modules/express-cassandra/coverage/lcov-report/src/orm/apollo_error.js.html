...
<head>
    <title>Code coverage report for src/orm/apollo_error.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/orm</a> apollo_error.js</h1>
        <div class='clearfix'>
...
<span class="branch-1 cbranch-no" title="branch not covered" >  const n</span>ame = argsarray.length ? argsarray.shift() : '_none_given_';
&nbsp;
  const errorTemplate = AERROR_TYPES[name] || <span class="branch-1 cbranch-no" title="branch not covered" >AERROR_TYPES.unspecified;</span>
  const errorMsg = argsarray.length
    ? util.format.apply(this, [errorTemplate.msg].concat(argsarray))
    : <span class="branch-1 cbranch-no" title="branch not covered" >errorTemplate.msg;</span>
&nbsp;
  const error = new Error(errorMsg);
  error.name = <span class="branch-1 cbranch-no" title="branch not covered" >(E</span>RR_NAME_PREFIX ? util.format('%s.', ERR_NAME_PREFIX) : '') + name;
&nbsp;
  return error;
};
&nbsp;
