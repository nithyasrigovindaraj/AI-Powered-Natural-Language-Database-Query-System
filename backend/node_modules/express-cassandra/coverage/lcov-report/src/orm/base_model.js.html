...
<head>
    <title>Code coverage report for src/orm/base_model.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/orm</a> base_model.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">64.22% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>429/668</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>176/304</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">61.79% </span>
                <span class="quiet">Functions</span>
                <span class='fraction'>55/89</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">62.73% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>399/636</span>
            </div>
...
<a name='L1154'></a><a href='#L1154'>1154</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">63x</span>
<span class="cline-any cline-yes">40977x</span>
<span class="cline-any cline-yes">21046x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40977x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">63x</span>
<span class="cline-any cline-yes">40365x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">63x</span>
<span class="cline-any cline-yes">63x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">63x</span>
<span class="cline-any cline-yes">1058x</span>
<span class="cline-any cline-yes">1058x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1058x</span>
<span class="cline-any cline-yes">1058x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">100095x</span>
<span class="cline-any cline-yes">20019x</span>
...
<span class="cline-any cline-yes">20019x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20016x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20016x</span>
<span class="cline-any cline-yes">20004x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20004x</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >  instanceValues = i</span>nstanceValues || {};
  const fieldValues = {};
...
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.validator.invalidschema', e.message));
    }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!schemer.validate_table_name(tableName)) {
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.tablecreation.invalidname', tableName));
  }
&nbsp;
...
&nbsp;
  ...
  if (!migration) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (properties.dropTableOnSchemaChange) migration = 'drop';
    else <span class="cstat-no" title="statement not covered" >migration = 'safe';</span>
  }
  // always safe migrate if NODE_ENV==='production'
  <span class="missing-if-branch" title="if path not taken" >I</span>if (process.env.NODE_ENV === 'production') <span class="cstat-no" title="statement not covered" >migration = 'safe';</span>
&nbsp;
...
&nbsp;
    const <span class="fstat-no" title="function not covered" >afterDBCreate = (</span>err1) =&gt; {
<span class="cstat-no" title="statement not covered" >      if (err1) {</span>
<span class="cstat-no" title="statement not covered" >        callback(err1);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      const i</span>ndexingTasks = [];
&nbsp;
      // cassandra index create if defined
<span class="cstat-no" title="statement not covered" >      if (_.isArray(modelSchema.indexes)) {</span>
<span class="cstat-no" title="statement not covered" >        tableBuilder.createIndexesAsync = P</span>romise.promisify(tableBuilder.create_indexes);
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(t</span>ableBuilder.createIndexesAsync(modelSchema.indexes));
      }
      // cassandra custom index create if defined
<span class="cstat-no" title="statement not covered" >      if (_.isArray(modelSchema.custom_indexes)) {</span>
<span class="cstat-no" title="statement not covered" >        tableBuilder.createCustomIndexesAsync = P</span>romise.promisify(tableBuilder.create_custom_indexes);
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(t</span>ableBuilder.createCustomIndexesAsync(modelSchema.custom_indexes));
      }
<span class="cstat-no" title="statement not covered" >      if (modelSchema.custom_index) {</span>
<span class="cstat-no" title="statement not covered" >        tableBuilder.createCustomIndexAsync = P</span>romise.promisify(tableBuilder.create_custom_indexes);
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(t</span>ableBuilder.createCustomIndexAsync([modelSchema.custom_index]));
      }
      // materialized view create if defined
<span class="cstat-no" title="statement not covered" >      if (modelSchema.materialized_views) {</span>
<span class="cstat-no" title="statement not covered" >        tableBuilder.createViewsAsync = P</span>romise.promisify(tableBuilder.create_mviews);
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(t</span>ableBuilder.createViewsAsync(modelSchema.materialized_views));
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      Promise.all(indexingTasks)</span>
...
<span class="cstat-no" title="statement not covered" >          callback(null, true);</span>
        ...
        .catch(<span class="fstat-no" title="function not covered" >(err2) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          callback(err2);</span>
        });
    };
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!dbSchema) {
<span class="cstat-no" title="statement not covered" >      if (properties.createTable === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.tablecreation.schemanotfound', tableName));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      // if not existing, it's created
<span class="cstat-no" title="statement not covered" >      tableBuilder.create_table(modelSchema, afterDBCreate);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isEqual(normalizedModelSchema, normalizedDBSchema)) {
      // no change in db was made, so callback with false
      callback(null, false);
      return;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (migration === 'alter') {</span>
      // check if table can be altered to match schema
<span class="cstat-no" title="statement not covered" >      if (_.isEqual(normalizedModelSchema.key, normalizedDBSchema.key)</span>
          &amp;&amp; _.isEqual(normalizedModelSchema.clustering_order, normalizedDBSchema.clustering_order)) {
<span class="cstat-no" title="statement not covered" >        tableBuilder.init_alter_operations(modelSchema, dbSchema, normalizedModelSchema, normalizedDBSchema, <span class="fstat-no" title="function not covered" >(</span>err1) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (err1 &amp;&amp; err1.message === 'alter_impossible') {</span>
<span class="cstat-no" title="statement not covered" >            tableBuilder.drop_recreate_table(modelSchema, n</span>ormalizedDBSchema.materialized_views, afterDBCreate);
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
<span class="cstat-no" title="statement not covered" >          callback(err1);</span>
        });
...
<span class="cstat-no" title="statement not covered" >        tableBuilder.drop_recreate_table(modelSchema, n</span>ormalizedDBSchema.materialized_views, afterDBCreate);
    ...
    } else <span class="cstat-no" title="statement not covered" >if (migration === 'drop') {</span>
<span class="cstat-no" title="statement not covered" >      tableBuilder.drop_recreate_table(modelSchema, n</span>ormalizedDBSchema.materialized_views, afterDBCreate);
    } else {
<span class="cstat-no" title="statement not covered" >      callback(b</span>uildError('model.tablecreation.schemamismatch', tableName, 'migration suspended, please apply the change manually'));
    }
  });
};
&nbsp;
BaseModel._sync_es_index = function f(callback) {
  const properties = this._properties;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (properties.esclient &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >properties.schema.es_index_mapping) {</span>
    const keyspaceName = <span class="cstat-no" title="statement not covered" >properties.keyspace;</span>
    const mappingName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
    const indexName = `<span class="cstat-no" title="statement not covered" >${keyspaceName}_${mappingName}`;</span>
&nbsp;
    const elassandraBuilder = <span class="cstat-no" title="statement not covered" >new ElassandraBuilder(p</span>roperties.esclient);
<span class="cstat-no" title="statement not covered" >    elassandraBuilder.assert_index(keyspaceName, indexName, <span class="fstat-no" title="function not covered" >(</span>err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        callback(err);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      elassandraBuilder.put_mapping(indexName, mappingName, p</span>roperties.schema.es_index_mapping, callback);
    });
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
  callback();
...
BaseModel._sync_graph = function f(callback) {
  const properties = this._properties;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (properties.gremlin_client &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >properties.schema.graph_mapping) {</span>
    const graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
    const mappingName = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
&nbsp;
    const graphBuilder = <span class="cstat-no" title="statement not covered" >new JanusGraphBuilder(p</span>roperties.gremlin_client);
<span class="cstat-no" title="statement not covered" >    graphBuilder.assert_graph(graphName, <span class="fstat-no" title="function not covered" >(</span>err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        callback(err);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      graphBuilder.put_mapping(graphName, mappingName, p</span>roperties.schema.graph_mapping, callback);
    });
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
  callback();
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.is_table_ready()) {
    doExecuteQuery(callback);
  } else {
<span class="cstat-no" title="statement not covered" >    this.init(<span class="fstat-no" title="function not covered" >(</span>err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        callback(err);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      doExecuteQuery(callback);</span>
    });
  }
};
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.allow_filtering) <span class="cstat-no" title="statement not covered" >query += ' ALLOW FILTERING';</span>
&nbsp;
  query += ';';
&nbsp;
...
&nbsp;
BaseModel.get_keyspace_name = <span class="fstat-no" title="function not covered" >function f() {</span>
<span class="cstat-no" title="statement not covered" >  return t</span>his._properties.keyspace;
};
&nbsp;
...
&nbsp;
BaseModel.init = <span class="fstat-no" title="function not covered" >function f(options, callback) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._ready = true;</span>
...
&nbsp;
    this._sync_es_index((err1) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err1) {
<span class="cstat-no" title="statement not covered" >        callback(err1);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
&nbsp;
BaseModel.get_es_client = <span class="fstat-no" title="function not covered" >function f() {</span>
<span class="cstat-no" title="statement not covered" >  if (!this._properties.esclient) {</span>
<span class="cstat-no" title="statement not covered" >    throw (n</span>ew Error('To use elassandra features, set `manageESIndex` to true in ormOptions'));
  }
<span class="cstat-no" title="statement not covered" >  return t</span>his._properties.esclient;
};
&nbsp;
BaseModel.get_gremlin_client = <span class="fstat-no" title="function not covered" >function f() {</span>
<span class="cstat-no" title="statement not covered" >  if (!this._properties.gremlin_client) {</span>
<span class="cstat-no" title="statement not covered" >    throw (n</span>ew Error('To use janus graph features, set `manageGraphs` to true in ormOptions'));
  }
<span class="cstat-no" title="statement not covered" >  return t</span>his._properties.gremlin_client;
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.execute_eachRow(query, params, options, onReadable, callback);</span>
    });
  }
};
&nbsp;
BaseModel.eachRow = function f(queryObject, options, onReadable, callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length === 3) {
<span class="cstat-no" title="statement not covered" >    const c</span>b = onReadable;
<span class="cstat-no" title="statement not covered" >    onReadable = options;</span>
<span class="cstat-no" title="statement not covered" >    callback = cb;</span>
<span class="cstat-no" title="statement not covered" >    options = {};</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof onReadable !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.find.eachrowerror', 'no valid onReadable function was provided'));
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.find.cberror'));
  }
&nbsp;
  const defaults = {
    raw: false,
...
&nbsp;
  this._execute_table_eachRow(selectQuery.query, selectQuery.params, queryOptions, (n, row) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.raw) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >      callback(b</span>uildError('model.find.dberror', err));
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    callback(err, result);
  });
...
<span class="cstat-no" title="statement not covered" >      this.execute_stream(query, params, options, onReadable, callback);</span>
    });
  }
};
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof onReadable !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.find.streamerror', 'no valid onReadable function was provided'));
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.find.cberror'));
  }
...
&nbsp;
BaseModel._execute_gremlin_query = <span class="fstat-no" title="function not covered" >function f(script, bindings, callback) {</span>
  const gremlinClient = <span class="cstat-no" title="statement not covered" >this.get_gremlin_client();</span>
<span class="cstat-no" title="statement not covered" >  gremlinClient.execute(script, bindings, <span class="fstat-no" title="function not covered" >(</span>err, results) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      callback(err);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    callback(null, results);</span>
  });
};
&nbsp;
BaseModel._execute_gremlin_script = <span class="fstat-no" title="function not covered" >function f(script, bindings, callback) {</span>
<span class="cstat-no" title="statement not covered" >  this._execute_gremlin_query(script, bindings, <span class="fstat-no" title="function not covered" >(</span>err, results) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      callback(err);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    callback(null, r</span>esults[0]);
  });
};
&nbsp;
BaseModel.createVertex = <span class="fstat-no" title="function not covered" >function f(vertexProperties, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  const __vertexLabel = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
  let script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
    vertex = graph.addVertex(__vertexLabel);
  `;
<span class="cstat-no" title="statement not covered" >  Object.keys(vertexProperties).forEach(<span class="fstat-no" title="function not covered" >(</span>property) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    script += `v</span>ertex.property('${property}', ${property});`;
  });
<span class="cstat-no" title="statement not covered" >  script += 'vertex';</span>
  const bindings = <span class="cstat-no" title="statement not covered" >_.defaults({}, vertexProperties, {</span>
    __graphName,
    __vertexLabel,
  });
<span class="cstat-no" title="statement not covered" >  this._execute_gremlin_script(script, bindings, callback);</span>
};
&nbsp;
BaseModel.getVertex = <span class="fstat-no" title="function not covered" >function f(__vertexId, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  const script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
    g = graph.traversal();
    vertex = g.V(__vertexId);
  `;
  const bindings = <span class="cstat-no" title="statement not covered" >{</span>
    __graphName,
    __vertexId,
  };
<span class="cstat-no" title="statement not covered" >  this._execute_gremlin_script(script, bindings, callback);</span>
...
&nbsp;
BaseModel.updateVertex = <span class="fstat-no" title="function not covered" >function f(__vertexId, vertexProperties, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  let script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
...
&nbsp;
BaseModel.deleteVertex = <span class="fstat-no" title="function not covered" >function f(__vertexId, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  const script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
...
&nbsp;
BaseModel.createEdge = <span class="fstat-no" title="function not covered" >function f(__edgeLabel, __fromVertexId, __toVertexId, edgeProperties, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (arguments.length === 4 &amp;&amp; typeof edgeProperties === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    callback = edgeProperties;</span>
<span class="cstat-no" title="statement not covered" >    edgeProperties = {};</span>
  }
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  let script = `<span class="cstat-no" title="statement not covered" ></span>
  ...
  `;
<span class="cstat-no" title="statement not covered" >  Object.keys(edgeProperties).forEach(<span class="fstat-no" title="function not covered" >(</span>property) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    script += `e</span>dge.property('${property}', ${property});`;
  });
<span class="cstat-no" title="statement not covered" >  script += 'edge';</span>
  const bindings = <span class="cstat-no" title="statement not covered" >_.defaults({}, edgeProperties, {</span>
    __graphName,
    __fromVertexId,
    __toVertexId,
    __edgeLabel,
...
&nbsp;
BaseModel.getEdge = <span class="fstat-no" title="function not covered" >function f(__edgeId, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  const script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
...
&nbsp;
BaseModel.updateEdge = <span class="fstat-no" title="function not covered" >function f(__edgeId, edgeProperties, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  let script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
...
&nbsp;
BaseModel.deleteEdge = <span class="fstat-no" title="function not covered" >function f(__edgeId, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  const script = `<span class="cstat-no" title="statement not covered" ></span>
    graph = ConfiguredGraphFactory.open(__graphName);
...
&nbsp;
BaseModel.graphQuery = <span class="fstat-no" title="function not covered" >function f(query, params, callback) {</span>
  const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
  const __graphName = `<span class="cstat-no" title="statement not covered" >${properties.keyspace}_graph`;</span>
  const __vertexLabel = <span class="cstat-no" title="statement not covered" >properties.table_name;</span>
  let script = `<span class="cstat-no" title="statement not covered" ></span>
  ...
  `;
<span class="cstat-no" title="statement not covered" >  script += query;</span>
  const bindings = <span class="cstat-no" title="statement not covered" >_.defaults({}, params, {</span>
    __graphName,
    __vertexLabel,
  });
<span class="cstat-no" title="statement not covered" >  this._execute_gremlin_query(script, bindings, callback);</span>
};
&nbsp;
BaseModel.search = <span class="fstat-no" title="function not covered" >function f(queryObject, callback) {</span>
  const esClient = <span class="cstat-no" title="statement not covered" >this.get_es_client();</span>
  const indexName = `<span class="cstat-no" title="statement not covered" >${this._properties.keyspace}_${this._properties.table_name}`;</span>
&nbsp;
  const query = <span class="cstat-no" title="statement not covered" >_.defaults({}, queryObject, {</span>
    index: indexName,
    type: this._properties.table_name,
  });
<span class="cstat-no" title="statement not covered" >  esClient.search(query, <span class="fstat-no" title="function not covered" >(</span>err, response) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      callback(err);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
...
BaseModel.find = function f(queryObject, options, callback) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function' &amp;&amp; !options.return_query) {
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.find.cberror'));
  }
&nbsp;
  const defaults = {
...
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(e, callback);</span>
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
...
BaseModel.findOne = function f(queryObject, options, callback) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!options.return_query) {</span>
<span class="cstat-no" title="statement not covered" >    throw (b</span>uildError('model.find.cberror'));
  }
&nbsp;
  queryObject.$limit = 1;
...
&nbsp;
  options = _.defaultsDeep({}, options, defaults);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.before_update === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.before_update(queryObject, updateValues, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(b</span>uildError('model.update.before.error'), callback);
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
...
&nbsp;
  if (options.conditions) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ifClause.query) {
...
&nbsp;
  if (options.return_query) {
    const returnObj = {
      ...
      params: finalParams,
      after_hook: () =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_update === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_update(queryObject, updateValues, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >          return b</span>uildError('model.update.after.error');
        }
        return true;
      },
    };
...
&nbsp;
  this._execute_table_query(query, finalParams, queryOptions, (err, results) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof callback === 'function') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.update.dberror', err));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_update === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_update(queryObject, updateValues, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.update.after.error'));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      callback(null, results);
    } else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.update.dberror', err));
    } else <span class="cstat-no" title="statement not covered" >if (typeof schema.after_update === 'function' &amp;&amp; schema.after_update(queryObject, updateValues, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.update.after.error'));
    }
  });
&nbsp;
  return {};
...
&nbsp;
  options = _.defaultsDeep({}, options, defaults);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.before_delete === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.before_delete(queryObject, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(b</span>uildError('model.delete.before.error'), callback);
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
  let queryParams = [];
...
&nbsp;
  if (options.return_query) {
    const returnObj = {
      ...
      params: queryParams,
      after_hook: () =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_delete === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_delete(queryObject, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >          return b</span>uildError('model.delete.after.error');
        }
        return true;
      },
    };
...
&nbsp;
  this._execute_table_query(query, queryParams, queryOptions, (err, results) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof callback === 'function') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.delete.dberror', err));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_delete === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_delete(queryObject, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.delete.after.error'));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      callback(null, results);
    } else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.delete.dberror', err));
    } else <span class="cstat-no" title="statement not covered" >if (typeof schema.after_delete === 'function' &amp;&amp; schema.after_delete(queryObject, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.delete.after.error'));
    }
  });
&nbsp;
  return {};
...
&nbsp;
BaseModel.prototype.get_data_types = <span class="fstat-no" title="function not covered" >function f() {</span>
<span class="cstat-no" title="statement not covered" >  return c</span>ql.types;
};
&nbsp;
...
&nbsp;
BaseModel.prototype.get_keyspace_name = <span class="fstat-no" title="function not covered" >function f() {</span>
<span class="cstat-no" title="statement not covered" >  return t</span>his.constructor.get_keyspace_name();
};
&nbsp;
...
BaseModel.prototype.validate = function f(propertyName, value) {
  value = value || <span class="branch-1 cbranch-no" title="branch not covered" >this[propertyName];</span>
<span class="branch-1 cbranch-no" title="branch not covered" >  this._validators = t</span>his._validators || {};
  return <span class="branch-1 cbranch-no" title="branch not covered" >schemer.get_validation_message(t</span>his._validators[propertyName] || [], value);
};
&nbsp;
...
&nbsp;
  options = _.defaultsDeep({}, options, defaults);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.before_save === 'function' &amp;&amp; schema.before_save(this, options) === false) {
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(b</span>uildError('model.save.before.error'), callback);
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
  const {
...
&nbsp;
  if (options.return_query) {
    const returnObj = {
      ...
      params: finalParams,
      after_hook: () =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_save === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_save(this, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >          return b</span>uildError('model.save.after.error');
        }
        return true;
      },
    };
...
&nbsp;
  this.constructor._execute_table_query(query, finalParams, queryOptions, (err, result) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof callback === 'function') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.save.dberror', err));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_save === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_save(this, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(b</span>uildError('model.save.after.error'));
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      callback(null, result);
    } else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.save.dberror', err));
    } else <span class="cstat-no" title="statement not covered" >if (typeof schema.after_save === 'function' &amp;&amp; schema.after_save(this, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >      throw (b</span>uildError('model.save.after.error'));
    }
  });
&nbsp;
  return {};
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu Aug 15 2024 23:45:07 GMT+0600 (Bangladesh Standard Time)
            </div>
