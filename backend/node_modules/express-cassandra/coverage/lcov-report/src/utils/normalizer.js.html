...
<head>
    <title>Code coverage report for src/utils/normalizer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> normalizer.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>96/136</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>122/143</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">379x</span>
...
const arraySort = (a, b) =&gt; {
  if (a &gt; b) return 1;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (a &lt; b) return -1;
...
&nbsp;
  normalize_query_option(options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.consistency) <span class="cstat-no" title="statement not covered" >queryOptions.consistency = o</span>ptions.consistency;
    if (options.fetchSize) queryOptions.fetchSize = options.fetchSize;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.autoPage) <span class="cstat-no" title="statement not covered" >queryOptions.autoPage = o</span>ptions.autoPage;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.hints) <span class="cstat-no" title="statement not covered" >queryOptions.hints = o</span>ptions.hints;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.pageState) <span class="cstat-no" title="statement not covered" >queryOptions.pageState = o</span>ptions.pageState;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.retry) <span class="cstat-no" title="statement not covered" >queryOptions.retry = o</span>ptions.retry;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.serialConsistency) <span class="cstat-no" title="statement not covered" >queryOptions.serialConsistency = o</span>ptions.serialConsistency;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.customPayload) <span class="cstat-no" title="statement not covered" >queryOptions.customPayload = o</span>ptions.customPayload;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.isIdempotent) <span class="cstat-no" title="statement not covered" >queryOptions.isIdempotent = o</span>ptions.isIdempotent;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.readTimeout) <span class="cstat-no" title="statement not covered" >queryOptions.readTimeout = o</span>ptions.readTimeout;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.retry) <span class="cstat-no" title="statement not covered" >queryOptions.retry = o</span>ptions.retry;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.retryOnTimeout) <span class="cstat-no" title="statement not covered" >queryOptions.retryOnTimeout = o</span>ptions.retryOnTimeout;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.routingIndexes) <span class="cstat-no" title="statement not covered" >queryOptions.routingIndexes = o</span>ptions.routingIndexes;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.routingKey) <span class="cstat-no" title="statement not covered" >queryOptions.routingKey = o</span>ptions.routingKey;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.routingNames) <span class="cstat-no" title="statement not covered" >queryOptions.routingNames = o</span>ptions.routingNames;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.timestamp) <span class="cstat-no" title="statement not covered" >queryOptions.timestamp = o</span>ptions.timestamp;
    return queryOptions;
  },
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (outputSchema.key &amp;&amp; outputSchema.key.length) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (outputMView.key &amp;&amp; outputMView.key.length) {
...
&nbsp;
  normalize_custom_indexes(outputSchema) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (outputSchema.custom_index) {
<span class="cstat-no" title="statement not covered" >      outputSchema.custom_indexes = [</span>outputSchema.custom_index];
<span class="cstat-no" title="statement not covered" >      delete o</span>utputSchema.custom_index;
    }
&nbsp;
    if (outputSchema.custom_indexes) {
      const customArraySort = (a, b) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (a.on &gt; b.on) return 1;
<span class="cstat-no" title="statement not covered" >        if (a.on &lt; b.on) <span class="cstat-no" title="statement not covered" >return -</span></span>1;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (a.using &gt; b.using) <span class="cstat-no" title="statement not covered" >return 1;</span></span>
<span class="cstat-no" title="statement not covered" >        if (a.using &lt; b.using) <span class="cstat-no" title="statement not covered" >return -</span></span>1;
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (a.options &gt; b.options) <span class="cstat-no" title="statement not covered" >return 1;</span></span>
<span class="cstat-no" title="statement not covered" >        if (a.options &lt; b.options) <span class="cstat-no" title="statement not covered" >return -</span></span>1;
&nbsp;
<span class="cstat-no" title="statement not covered" >        return 0;</span>
      };
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  remove_dependent_views_from_normalized_schema(normalizedDBSchema, dbSchema, fieldName) {</span>
<span class="cstat-no" title="statement not covered" >    const d</span>ependentViews = [];
<span class="cstat-no" title="statement not covered" >    Object.keys(n</span>ormalizedDBSchema.materialized_views).forEach(<span class="fstat-no" title="function not covered" >(dbViewName) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (normalizedDBSchema.materialized_views[dbViewName].select.includes(fieldName)) {</span>
<span class="cstat-no" title="statement not covered" >        dependentViews.push(dbViewName);</span>
      } else <span class="cstat-no" title="statement not covered" >if (normalizedDBSchema.materialized_views[dbViewName].select[0] === '*') {</span>
<span class="cstat-no" title="statement not covered" >        dependentViews.push(dbViewName);</span>
      } else <span class="cstat-no" title="statement not covered" >if (normalizedDBSchema.materialized_views[dbViewName].key.includes(fieldName)) {</span>
<span class="cstat-no" title="statement not covered" >        dependentViews.push(dbViewName);</span>
      } else <span class="cstat-no" title="statement not covered" >if (_.isArray(normalizedDBSchema.materialized_views[dbViewName].key[0])</span>
                  &amp;&amp; normalizedDBSchema.materialized_views[dbViewName].key[0].includes(fieldName)) {
<span class="cstat-no" title="statement not covered" >        dependentViews.push(dbViewName);</span>
      }
    });
<span class="cstat-no" title="statement not covered" >    dependentViews.forEach(<span class="fstat-no" title="function not covered" >(</span>viewName) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      normalizedDBSchema.materialized_views[viewName] = {};</span>
    });
  },
};
&nbsp;
