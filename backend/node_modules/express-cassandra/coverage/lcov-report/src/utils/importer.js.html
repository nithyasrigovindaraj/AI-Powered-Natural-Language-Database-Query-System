...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> importer.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40016x</span>
<span class="cline-any cline-yes">20005x</span>
<span class="cline-any cline-yes">20005x</span>
<span class="cline-any cline-yes">20005x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20005x</span>
<span class="cline-any cline-yes">40015x</span>
...
<span class="cstat-no" title="statement not covered" >          return B</span>uffer.from(param);
        }
        const omittedParams = <span class="cstat-no" title="statement not covered" >_.omitBy(param, <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(</span>item) =&gt; (i</span></span>tem === null));
<span class="cstat-no" title="statement not covered" >        Object.keys(omittedParams).forEach(<span class="fstat-no" title="function not covered" >(</span>key) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (_.isObject(omittedParams[key]) &amp;&amp; omittedParams[key].type === 'Buffer') {</span>
<span class="cstat-no" title="statement not covered" >            omittedParams[key] = B</span>uffer.from(omittedParams[key]);
          }
        });
