...
<head>
    <title>Code coverage report for src/utils/exporter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> exporter.js</h1>
        <div class='clearfix'>
...
const exporter = {
  processTableExport(systemClient, fixtureDirectory, keyspace, table) {
    ...
    return new Promise((resolve, reject) =&gt; {
      ...
      jsonfile.on('error', <span class="fstat-no" title="function not covered" >(err) =&gt; {</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >        const t</span>hroughput = timeTaken ? processed / timeTaken : 0.00;
