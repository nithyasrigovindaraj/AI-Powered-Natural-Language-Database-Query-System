...
<head>
    <title>Code coverage report for src/helpers/driver.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/helpers</a> driver.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1475x</span>
...
Driver.prototype = {
  ensure_init(callback) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._properties.cql) {
<span class="cstat-no" title="statement not covered" >      this._properties.init(callback);</span>
    } else {
      callback();
    }
  },
&nbsp;
<span class="fstat-no" title="function not covered" >  execute_definition_query(query, callback) <span class="cstat-no" title="statement not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >    this.ensure_init(<span class="fstat-no" title="function not covered" >(</span>err) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        callback(err);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
<span class="cstat-no" title="statement not covered" >      debug('executing definition query: %s', query);</span>
      const properties = <span class="cstat-no" title="statement not covered" >this._properties;</span>
      const conn = <span class="cstat-no" title="statement not covered" >properties.define_connection;</span>
<span class="cstat-no" title="statement not covered" >      conn.execute(query, [], {</span> prepare: false, fetchSize: 0 }, callback);
    });
  },
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return;</span>
      ...
      this._properties.cql.execute(query, params, options, (err1, result) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err1 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >err1.code === 8704) {</span>
<span class="cstat-no" title="statement not covered" >          this.execute_definition_query(query, callback);</span>
        } else {
