...
<head>
    <title>Code coverage report for src/validators/datatypes.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/validators</a> datatypes.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">40062x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
...
validators.is_decimal = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(obj) =&gt; ((o</span></span>bj instanceof cql.types.BigDecimal));
validators.is_integer = (obj) =&gt; (check.integer(obj));
validators.is_var_int = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(obj) =&gt; ((o</span></span>bj instanceof cql.types.Integer));
...
validators.is_local_date = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(obj) =&gt; ((o</span></span>bj instanceof cql.types.LocalDate));
validators.is_local_time = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(obj) =&gt; ((o</span></span>bj instanceof cql.types.LocalTime));
validators.is_date = (obj) =&gt; (check.date(new Date(obj)));
validators.is_buffer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(obj) =&gt; ((o</span></span>bj instanceof Buffer));
validators.is_timeuuid = (obj) =&gt; ((obj instanceof cql.types.TimeUuid));
validators.is_uuid = (obj) =&gt; ((obj instanceof cql.types.Uuid));
validators.is_inet = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(obj) =&gt; ((o</span></span>bj instanceof cql.types.InetAddress));
...
TYPE_MAP.generic_type_validator = function f(fieldtype) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this[fieldtype]) <span class="cstat-no" title="statement not covered" >return null;</span>
&nbsp;
  return {
